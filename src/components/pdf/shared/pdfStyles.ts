...
export function createPDFStyles(accentColor: string) {
  return StyleSheet.create({
    ...
    customerName: { fontSize: 11, fontWeight: "bold", marginBottom: 2, wordBreak: "break-word", flexWrap: "wrap" },
    customerDetail: { fontSize: 9, color: "#4b5563", lineHeight: 1.4, wordBreak: "break-word", flexWrap: "wrap" },
