                  ...
                  <td className="px-4 py-3 text-center">
                    ...
                    <div className="relative inline-block" onClick={(e) => e.stopPropagation()}>
                      <select
                        ...
                        className={`inline-block pl-2.5 pr-6 py-0.5 rounded-full text-xs font-medium border-0 cursor-pointer hover:opacity-80 transition-opacity focus:outline-none focus:ring-2 focus:ring-green-500 appearance-none text-left ${STATUS_COLORS[q.status]}`}
